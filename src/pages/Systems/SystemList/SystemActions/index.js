...
const SystemActions = ({ search, setSearch, action, setAction, project, setProject, onAction }) => {
    ...
    <Card className={classes.root}>
      <CardContent className={classes.content}>
        ...
        <div className={classes.container}>
          <VektorSearchInput placeholder="Search" className={classes.input} value={search} onChange={(e) => setSearch(e.target.value)} />
          <FilterSelect
            label="Action:"
